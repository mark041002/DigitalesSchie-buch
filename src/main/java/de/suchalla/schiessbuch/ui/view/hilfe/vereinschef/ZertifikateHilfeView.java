...
/**
 * Hilfe-Seite für Zertifikate (Vereinschef) - stellt Aufseher-Inhalte bereit
 */
@Route(value = "hilfe/vereinschef/zertifikate", layout = MainLayout.class)
@PageTitle("Hilfe: Zertifikate")
@PermitAll
public class ZertifikateHilfeView extends BaseHilfeView {

    public ZertifikateHilfeView() {
        super("vereinschef", "zertifikate", "var(--lumo-success-color)");
    }
